...
public class SimpleCloudHandler : MonoBehaviour, Vuforia.ICloudRecoEventHandler 
{
	...
	public void OnNewSearchResult(TargetFinder.TargetSearchResult targetSearchResult)
    {
        ...
        ObjectTracker mImageTracker1 = mImageTracker;
        TrackableBehaviour imageTargetBehaviour = GetTargetFinder(mImageTracker1).EnableTracking(targetSearchResult, newImageTarget);
        ...
        switch (model_name)
        {
            ...
            case "Cat":
                ...
                Destroy( imageTargetBehaviour.gameObject.transform.Find("Mouse").gameObject );

                break;

            case "Mouse":

               Destroy( imageTargetBehaviour.gameObject.transform.Find("Cat").gameObject );
    ...
    private static TargetFinder GetTargetFinder(ObjectTracker mImageTracker1)
    {
        return mImageTracker1.TargetFinder;
    }
